...
public class ControlSpeedRecyclerViewFragment extends BaseFragment{

    public static ControlSpeedRecyclerViewFragment newInstance() {
        ControlSpeedRecyclerViewFragment fragment = new ControlSpeedRecyclerViewFragment();
