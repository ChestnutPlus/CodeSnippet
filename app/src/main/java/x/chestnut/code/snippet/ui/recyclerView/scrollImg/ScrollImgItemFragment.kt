...
import x.chestnut.code.snippet.ui.recyclerView.multiItem.*
import java.util.*
 ...
 */
class ScrollImgItemFragment : BaseFragment() {
    ...
    val beans: List<IMultiType>
        get() {
            ...
            for (longBgRe in longBgRes) {
                ...
                val itemScrollImgBean = ItemScrollImgBean()
