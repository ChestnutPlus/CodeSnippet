...
public class ItemDecorationStickySectionFragment extends BaseFragment{

    public static ItemDecorationStickySectionFragment newInstance() {
        ItemDecorationStickySectionFragment fragment = new ItemDecorationStickySectionFragment();
