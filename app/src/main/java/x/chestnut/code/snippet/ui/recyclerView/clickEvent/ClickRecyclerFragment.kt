 ...
 */
class ClickRecyclerFragment : BaseFragment() {
    ...
    override fun onLazyViewCreate(rootView: View) {
        ...
        val baseAdapter = ClickBaseUseAdapter(beans)
        baseAdapter.setOnItemClickListener(object : OnItemClickListener {
            override fun onItemClick(view: View?, position: Int, data: BaseUseBean) {
